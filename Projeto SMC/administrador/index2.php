    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2"><?php echo $_SESSION['local']?></h1>
            </div>
            ...
            <main role="main" class="inner cover text-center">
                <h1 class="cover-heading">Seja Bem Vindo! <?php echo $_SESSION['login']; ?>.</h1>
                <p class="lead">Tenha todos os recursos necessários para solucionar as
                    demandas de atendimento, de forma integrada e eficiente.</p>
            </main>

        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <table class="table table-striped position-relative" style="width: 1036px; right: 10px">
                    ...
                    $id1 = $_SESSION['id'];
                    $sql = "SELECT * FROM notes WHERE administrator_id='$id1' ";
                    ...
                    $sql2 = "SELECT * FROM notes WHERE administrator_id='$id1' LIMIT $inicio, $quantidade";
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center">
                            ...
                            <?php if ($pagina_anterior != 0){ ?>
                                <li class="page-item"><a class="page-link" href="nota2.php?pagina=<?php echo $pagina_anterior; ?>">  <<  </a></li>
                            <?php  }else{ ?>
                                <li class="page-item"><a class="page-link" href="#">  <<  </a></li>
                            <?php  } ?>

                            <?php for ($i = 1; $i < $num + 1; $i++){ ?>
                                <li class="page-item"><a class="page-link" href="nota2.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                            <?php } ?>

                            <?php if ($pagina_posterior <= $num){ ?>
                                <li class="page-item"><a class="page-link" href="nota2.php?pagina=<?php echo $pagina_posterior; ?>"> >> </a></li>
                            <?php  }else{ ?>
                                <li class="page-item"><a class="page-link" href="#">  >>  </a></li>
                            <?php  } ?>

        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Cadastrar Local</h1>
                </div>



                <form action="SalvarLocal.php" method="post">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input name="telefone" type="tel" class="form-control" placeholder="">
                        </div>
                        <div class="form-group col-md-6">
                            <label>Email</label>
                        ...
                        <div class="form-group col-md-6">
                            <label>Contato</label>
                            <input name="contato" type="tel" class="form-control" placeholder="">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input name="hr" type="text" class="form-control" placeholder="">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input name="predio" class="form-check-input" type="checkbox" value="S" >
                                <label class="form-check-label" >
                                    Sim
                                </label>
                            </div>
                            <div class="form-check">
                                <input name="predio" class="form-check-input" type="checkbox" value="N">
                                <label class="form-check-label" >
                                    Não
                                </label>
                            </div>
                    ...
                    <button value="1" name="botao" type="submit" class="btn btn-primary">Salvar</button>

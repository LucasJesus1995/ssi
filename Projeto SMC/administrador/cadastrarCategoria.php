            ...
            <form action="SalvarCategoria.php" method="post">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input name="categoria" type="text" class="form-control" placeholder="">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputPassword4">Publicação</label>
                        <input name="public" type="tel" class="form-control" id="inputPassword4" placeholder="">
                    </div>
                </div>

...
<%
  ...
  If blnSubmitNew Then
    ...
    Dim uid, uemail, uphone, ulocation, category, department, description
    ...
    ' If status is closed, then include the closed date/time
      If status = Cfg(cnnDB, "CloseStatus") Then
        ...
        "category, department, description, priority, status, start_date, rep, time_spent, " & _
        "close_date, entered_by, solution, kb) " & _
        "VALUES (" & id & ",'" & uid & "','" & uemail & "','" & uphone & "','" & _
        ulocation & "'," & category & "," & department & ",'" & _
    ...
    <tr class="Body1">
      <td valign="top" align="center" width="50%">
        <table class="narrow" border="0">
          ...
          <tr>
            <td>
              <b><%=lang(cnnDB, "UserName")%>:</b> <em>*</em></td>
            <td>
          ...
          <tr>
            ...
            <td>
              <input type="text" name="uemail" size="20" value="<% = Cfg(cnnDB, "BaseEmail") %>"></td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            ...
            <td>
            <input type="text" name="uphone" size="20">          </tr>
          <% 
          ...
          %>
            <tr>
              <td colspan="2">
                <div align="center">
                  <b>--- <%=lang(cnnDB, "Or")%> ---</b>                </div>              </td>
            </tr>
            <tr>
              <td colspan="2">
                <b><%=lang(cnnDB, "SelectUser")%>:</b>              </td>
            </tr>
            <tr>    
              <td colspan="2">
        ...
        <table class="narrow" border="0">
          ...
          <tr>
            ...
            <td>
              <SELECT NAME="rep">
              <%
                Set rstRepList = SQLQuery(cnnDB, "SELECT * From tblUsers WHERE IsRep2 = 1 AND RepAccess <> 2 AND sid > 0 ORDER BY uid ASC")
    ...
    <tr class="Body1">
      <td colspan="2">
        ...
        <% If Cfg(cnnDB, "EnableKB") <> 0 Then %>
          <br/><input type="checkbox" name="kb">&nbsp;<%=lang(cnnDB, "EnterinKnowledgeBase")%>
        <% End If %>
      </td>
    </tr>
    <tr class="Head2">

...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <%
    ...
    listStr = "SELECT TOP 100 p.id, p.start_date, p.uid, p.uemail, r.uid AS ruid, s.sname " & _
    ...
    If Len(Request.Form("keywords")) > 0 Then
      ...
      If Request.Form("description") <> "on" And Request.Form("solution") <> "on" Then
        blAllOff = True
      Else
        blAllOff = False
      End If
      ...
      <%
        ...
        %>
          <tr class="Body1" align="center">
            <td nowrap><A HREF="details.asp?id=<% = rstProbList("id") %>"><% = rstProbList("id") %></td>

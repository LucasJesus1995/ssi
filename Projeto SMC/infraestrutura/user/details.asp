...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <%
      ...
      "p.close_date, c.cname, r.uid As ruid, r.email1 As remail, r.fname, p.solution, p.description " & _
          ...
          <td colspan="2">
            <table class="Normal" border="0" cellspacing="0">
              ...
              <tr>
                ...
                <td>
                  <% = rstProblem("uemail") %>                </td>
              </tr>
              <tr>
                <td>
                  <b><%=lang(cnnDB, "Phone")%>:</b>                </td>
                <td>
                  <% = rstProblem("uphone") %>                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <% = DisplayDate(rstProblem("start_date"), lhdDateTime) %>                </td>
              </tr>
              <% If rstProblem("status") = Cfg(cnnDB, "CloseStatus") Then %>
                <tr>
                  ...
                  <td>
                    <% = DisplayDate(rstProblem("close_date"), lhdDateTime) %>                  </td>
                </tr>
              <% End If %>
              <tr>
                <td>
              ...
              <tr>
                ...
                <td>
                  <a href="mailto:<% = rstProblem("remail") %>?Subject=<%=lang(cnnDB, "HelpDesk")%>:&nbsp;<%=lang(cnnDB, "Problem")%>&nbsp;<% = id %>"><% = rstProblem("fname") %></a>                </td>
              </tr>
              <tr>
                <td>

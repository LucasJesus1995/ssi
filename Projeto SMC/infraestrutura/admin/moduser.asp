  ...
  <body>
    ...
    <%
      ...
      If Request.Form("save") = 1 Then
        ...
        Dim usrLanguage, IsRep2, RepAccess, InoutAdmin
        ...
        Dim blnRepProbs
        blnRepProbs = False
        If Request.Form("IsRep2") = "on" Then
          IsRep2 = 1
        Else
          If Usr(cnnDB, modSid, "IsRep2") = 1 Then
            Dim rstRepProbs
      ...
      If Request.Form("delete") = 1 Then
        ...
        If Usr(cnnDB, modSid, "IsRep2") = 0 Then
      ...
      Else
        ...
        Dim frm_statuscode, frm_statustext, frm_IsRep2, frm_RepAccess, frm_InoutAdmin
        ...
        frm_IsRep2 = Usr(cnnDB, modSid, "IsRep2")
            ...
            <td>
              <form name="upduser" action="moduser.asp" method="POST">
                ...
                <table class="Normal">
                  <tr>
                    <td colspan="2">
                      <div align="right"><i><em>*</em> = <%=lang(cnnDB, "Required")%></i></div>                    </td>
                  </tr>
                  <tr>
                    <td width="150">
                      <b><%=lang(cnnDB, "Username")%>: </b>                    </td>
                    <td>
                      <b><% = Usr(cnnDB, modSid, "uid") %></b>                    </td>
                  </tr>
                  <tr>
                    <td width="150">
                      <b><%=lang(cnnDB, "FirstName")%>: </b>                    </td>
                    <td>
                      <input type="text" name="firstname" size="30" value="<% = frm_firstname %>"><em>*</em>                    </td>
                  </tr>
                  <tr>
                    <td width="150">
                      <b><%=lang(cnnDB, "LastName")%>: </b>                    </td>
                    <td>
                      <input type="text" name="lastname" size="30" value="<% = frm_lastname %>"><em>*</em>                    </td>
                  </tr>
                  <tr>
                    <td width="150">
                      <b><%=lang(cnnDB, "EmailAddress")%>: </b>                    </td>
                    <td>
                      <input type="text" name="email" size="30" value="<% = frm_email %>"><em>*</em>                    </td>
                  </tr>
                  <% If (Cfg(cnnDB, "EnablePager") > 0) And (Usr(cnnDB, modSid, "IsRep2") = 1) Then %>
                  <tr>
                    <td width="150">
                      <b><%=lang(cnnDB, "PagerAddress")%>: </b>                    </td>
                    <td>
                      <input type="text" name="pager" size="30" value="<% = frm_pager %>">                    </td>
                  </tr>
                  <% Else %>
                  ...
                  <tr>
                    <td width="150">
                      <b><%=lang(cnnDB, "PhoneNumber")%>: </b>                    </td>
                    <td>
                      <input type="text" name="phone" size="30" value="<% = frm_phone %>">                    </td>
                  </tr>
                  <% if cfg(cnnDB,"useinoutboard") = 1 then %>
                    <tr>
                      <td width="150">
                        <b><%=lang(cnnDB, "HomePhone")%>: </b>                      </td>
                      <td>
                        <input type="text" name="phone_home" size="30" value="<% = frm_phone_home %>">                      </td>
                    </tr>
                    <tr>
                      <td width="150">
                        <b><%=lang(cnnDB, "MobilePhone")%>: </b>                      </td>
                      <td>
                        <input type="text" name="phone_mobile" size="30" value="<% = frm_phone_mobile %>">                      </td>
                    </tr>
                  <% Else %>
                  ...
                  <tr>
                    ...
                    %>
                            ...
                            <% = rstLang("LangName") %> (<% = rstLang("Localized") %>)                            </option>
                    <%			Else %>
                  ...
                  <tr class="Head2">
                    <td colspan="2">
                      <%=lang(cnnDB, "SupportRep")%>:                    </td>
                  </tr>
                  <tr>
                    <td>
                      <b><%=lang(cnnDB, "Enable")%>:</b>                    </td>
                    <td>
                      <% If frm_IsRep2 = 0 Then %>
                        <input type="checkbox" name="IsRep2">
                      <% Else %>
                        <input type="checkbox" name="IsRep2" checked>
                      <% End If %>                    </td>
                  </tr>
                  <tr>
                    <td>
                      <b><%=lang(cnnDB, "AccessLevel")%>:</b>                    </td>
                    <td>
                  ...
                  <% if cfg(cnnDB,"useinoutboard") = 1 then %>
                    <tr class="Head2">
                      <td colspan="2">
                        <%=lang(cnnDB, "InOutBoard")%>:                      </td>
                    </tr>
                    <tr>
                      <td width="150">
                        <b><%=lang(cnnDB, "Status")%>: </b>                      </td>
                      <td>
                    ...
                    <tr>
                      <td width="150">
                        <b><%=lang(cnnDB, "Status")%>&nbsp;<%=lang(cnnDB, "text")%>: </b>                      </td>
                      <td>
                        <input type="text" name="statustext" size="30" value="<% = frm_statustext %>">                      </td>
                    </tr>
                    <tr valign="top">
                      <td width="150">
                        <b><%=lang(cnnDB, "JobFunction")%>: </b>                      </td>
                      <td>
                        <textarea name="jobfunction" rows="4" cols="30"><% = frm_jobfunction %></textarea>                      </td>
                    </tr>
                    <tr valign="top">
                      <td width="150">
                        <b><%=lang(cnnDB, "Resume")%>: </b>                      </td>
                      <td>
                        <textarea name="userresume" rows="4" cols="30"><% = frm_userresume %></textarea>                      </td>
                    </tr>
                    <tr>
                      <td width="150">
                        <b><%=lang(cnnDB, "ListonBoard")%>: </b>                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <b><%=lang(cnnDB, "Administrator")%>:</b>                      </td>
                      <td>
                  ...
                  <tr class="Head2">
                    <td colspan="2">
                      <%=lang(cnnDB, "Password")%>:                    </td>
                  </tr>
                  <tr>
                    <td width="150">
                      <b><%=lang(cnnDB, "NewPassword")%>: </b>                    </td>
                    <td>
                      <input type="password" name="newpassword" size="30">                    </td>
                  </tr>
                </table>
                <p>
                <div align="center">

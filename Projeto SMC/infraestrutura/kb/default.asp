          ...
          <form method="post" action="default.asp">
            ...
            <div align="center">
              <table  class="Normal">
                <tr>
                  <td width="100">
                    <b><%=lang(cnnDB, "Keywords")%>:</b>                  </td>
                  <td>
                    <input type="text" size="50" name="keywords">                  </td>
                </tr>
                <tr>
                  <td valign="top">
                    <b><%=lang(cnnDB, "SearchFields")%>:</b>                  </td>
                  <td><input type="checkbox" name="description" checked> <%=lang(cnnDB, "Description")%><br />
                    <input type="checkbox" name="solution" checked> <%=lang(cnnDB, "Solution")%><br />                  </td>
                </tr>
              </table>
